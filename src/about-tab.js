export default function aboutTab() {
  ...
  aboutParagraph5.classList.add("about-paragraph5");
  ...
  aboutParagraph.appendChild(aboutParagraph5);
  ...
  aboutParagraph5.innerText =
    "~ Chef Ramenator Hiroshi NoodleMaster Tanaka-san";
  return subContainer;
}
